 ...
 * Заявки уходят обоим админам в личку бота: владелец 7738750071 и второй
 * админ 1203192763 (те же id, что и в ADMIN_IDS). Канал/группа не используются.
 * Каждый админ должен один раз нажать «Старт» боту в личке, иначе бот не сможет
 * ему написать.
 */
const TELEGRAM_CHAT_ID_DEFAULT = '7738750071,1203192763';
