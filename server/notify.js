...
/**
 * Получатели заявок (через запятую). Приоритет у TELEGRAM_CHAT_ID.
 * Заявки уходят обоим админам в личку бота (7738750071 и 1203192763, те же id,
 * что и в ADMIN_IDS) И в канал/группу. Канал указан в двух форматах:
 * -4325555891 (обычная группа) и -1004325555891 (супергруппа/канал) — какой
 * верный, туда и уйдёт, второй просто отвалится.
 * Каждый админ должен один раз нажать «Старт» боту в личке, иначе бот не сможет
 * ему написать.
 */
const TELEGRAM_CHAT_ID_DEFAULT = '7738750071,1203192763,-4325555891,-1004325555891';
